...
namespace LIVESTOCK.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<LIVESTOCK.Areas.CovidLab.Models.Patient> Patient { get; set; }
        public DbSet<LIVESTOCK.Areas.CovidLab.Models.PatientResults> PatientResults { get; set; }
        public DbSet<LIVESTOCK.Areas.CovidLab.Models.Lab> Lab { get; set; }      
