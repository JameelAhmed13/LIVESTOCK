...
namespace LIVESTOCK.Areas.website.Controllers
{
    ...
    {        
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Notifications = _context.Notification.Where(a => a.Visibility == true && a.ShowOnSlider == true).ToList();
            ViewBag.NewsEvent = _context.NewsEvent.Where(a => a.Visibility == true).ToList();
            ViewBag.Gallery = _context.Gallery.Where(a => a.Visibility == true).ToList();
            ViewBag.MainSlider = _context.MainSlider.OrderBy(a => a.OrderSequence).Where(a => a.Visibility == true).ToList();
            ViewBag.DGPR = _context.DGPR.Where(a => a.Visibility == true).ToList();
            ViewBag.Video = _context.Video.Where(a => a.Visibility == true).ToList();
