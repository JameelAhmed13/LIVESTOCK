...
namespace LIVESTOCK.Areas.website.Controllers
{
    ...
    public class CardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CardID,Heading,Description,PicturePath,OnDate,CreatedOn,Visibility")] Card card)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CardID,Heading,Description,PicturePath,OnDate,CreatedOn,Visibility")] Card card, IFormFile Attachment)
        {
            if (id != card.CardID)
            {
                return NotFound();
